  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#1a2332" }}>
      <section className="pt-24 pb-20 px-6 sm:px-8 lg:px-12 max-w-2xl mx-auto">
        ...
        <h1 className="text-5xl sm:text-6xl font-bold text-white mb-6">Join the Waitlist</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-600 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 outline-none transition-colors bg-gray-800/50 text-white placeholder-gray-400"
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 border border-gray-600 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 outline-none transition-colors bg-gray-800/50 text-white"
              >
            ...
            <button
              type="submit"
              className="w-full bg-cyan-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-cyan-700 transition-colors"
            >
              Join Waitlist
            </button>
